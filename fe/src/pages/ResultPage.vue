...
const EVENT_UI = {
  개인정보요구: {
    ...
    level: "위험",
    whyWrong: [
      "연락처, 이메일, 주소같은 개인정보는 항상 조심히 관리해야 합니다",
      "“더 편하게 이야기하자”, “중요한 걸 보내야 한다”는 명목은 전형적인 접근 패턴이에요.",
      "플랫폼 밖(카톡, 텔레그램 등)으로 유도하는 것은 추적을 피하고 가스라이팅을 시작하려는 전형적인 수법입니다."
    ],
    guide: [
      "요청 즉시 거절하고 대화 중단",
  ...
  금전요구: {
    ...
    level: "매우 위험",
    whyWrong: [
      "어떠한 이유에서도 직접 송금한 돈은 돌아오지 않습니다.",
    ],
    guide: ["송금 및 결제 요청 즉시 대화 중단", "이미 보냈다면 은행 및 수사기관(112,1332) 즉시 피해 신고", "대화 기록 캡처 후 신고"],
    phrases: ["“돈 거래는 하지 않습니다. 대화를 중단하겠습니다.”", "“직접적인 송금 요청은 사기로 간주하고 신고하겠습니다.”"],
    score: 5,
  },
  투자권유: {
    title: "투자 권유",
    level: "위험",
    whyWrong: ["세상에 '원금 보장'과 '고수익'이 동시에 존재하는 투자는 없습니다.",
      "초기에는 수익이 나는 것처럼 속여 더 큰 금액을 입금하게 만든 뒤 잠적하는 패턴입니다.",
    ],
    guide: ["원금/수익 보장 문구는 즉시 경고 신호로 판단", "검증된 금융기관/공식 앱 외 링크는 클릭 금지", "금융감독원 '파인(fine.fss.or.kr)'에서 제도권 금융기관인지 확인","개인 계좌로 투자금을 입금하라는 제안은 100% 사기"],
  ...
  앱설치유도: {
    title: "앱 설치 유도",
    level: "매우 위험",
    whyWrong: ["당신의 휴대폰은 사기꾼의 '좀비폰'이 되어 모든 정보가 실시간으로 빠져나갑니다.", "‘보안앱’ ‘인증앱’ 이라고 포장하는 경우가 많아요. 앱 설치를 요구하면 무조건 의심하세요"],
    guide: ["링크/파일 설치 요청 즉시 거절", "설치했다면 즉시 삭제 + 보안검사 + 금융앱 비밀번호 변경", "공식 스토어 외 설치는 금지"],
    phrases: ["“비공식적인 앱 설치는 하지 않습니다.”", "“공식 스토어/공식 채널로만 진행할게요.”"],
    score: 5,
  },
  사이트가입유도: {
    title: "사이트 가입 유도",
    ...
    guide: ["모르는 사이트 가입 금지", "URL을 검색/검증(공식 도메인 확인)", "가입 시 요구하는 인증번호를 절대로 타인에게 공유하지 말 것","의심되면 즉시 중단 + 신고"],
    phrases: ["“모르는 사이트에 제 정보를 입력하고 싶지 않아요.”", "“공식 도메인 확인 후에만 진행할게요.”"],
    score: 3,
  },
};
